...
class Scanner: NSObject
{
    ...
    private func scannerSetup() {
        ...
        scannerRect = delegate.scannerRect()
        ...
        previewLayer = self.createPreviewLayer(withCaptureSession: captureSession,
                                                   view: cameraView)
    ...
    private func createCaptureSession() -> AVCaptureSession? {
        do {
            ...
            if captureSession.canAddInput(deviceInput) && captureSession.canAddOutput(metaDataOutput) {
                ...
                //metaDataOutput.rectOfInterest = scannerRect
    ...
    private func createPreviewLayer(withCaptureSession captureSession: AVCaptureSession,
        ...
        //previewLayer.frame = CGRect(x: 50, y: 150, width: 300, height: 500)
    ...
    private func toggleCaptureSessionRunningState() {
        ...
        if !captureSession.isRunning {
            ...
            metaDataOutput.rectOfInterest = previewLayer.metadataOutputRectConverted(fromLayerRect: scannerRect)
        } else {
